...
@section('title')
    <title>Import Điểm Rèn Luyện</title>
@endsection
                    ...
                    <div class="col-6 mt-5">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Import điểm rèn luyện</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="POST" action="{{route('diemrenluyen.import')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">

...
@section('title')
    <title>Import Danh Sách Phụ Huynh</title>
@endsection
                    ...
                    <div class="col-6 mt-5">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Import danh sách phụ huynh</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form method="POST" action="{{route('phuhuynh.import')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
